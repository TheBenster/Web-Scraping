...
poetry_result = requests.get(poetry_url).text
poetry = BeautifulSoup(poetry_result, 'html.parser')

book_elements = poetry.find_all('tr', {'itemtype' : 'http://schema.org/Book'})
